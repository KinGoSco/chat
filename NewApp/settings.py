# # Assurez-vous que ces applications sont dans INSTALLED_APPS
# INSTALLED_APPS = [
...
# CHANNEL_LAYERS = {
#     'default': {
#         # Pour le développement, vous pouvez utiliser InMemoryChannelLayer
#         'BACKEND': 'channels.layers.InMemoryChannelLayer',
        
#         # Pour la production, utilisez Redis (nécessite channels_redis)
#         # 'BACKEND': 'channels.layers.RedisChannelLayer',
#         # 'CONFIG': {
#         #     'hosts': [('redis', 6379)],  # Adaptez à votre configuration Redis
#         # },
#     },
# }

# # Configuration ASGI pour Django Channels
# ASGI_APPLICATION = 'NewApp.asgi.application'  # Remplacez 'NewApp' par le nom de votre projet

# # Assurez-vous que REST_FRAMEWORK est configuré
# REST_FRAMEWORK = {
...
# # Définit le point d'entrée des URLs de votre projet
...
SECRET_KEY = 'django-insecure-65vp8#+#i(4qj)m19(f0xv&)^z)g_@80fauua2pqyzjc8165em'
...
ASGI_APPLICATION = 'NewApp.asgi.application'
